...
export type AuthSchemes = BasicAuth | ApiKey | BearerToken | NoAuth
...
type TransportMethod = WebhookMethod | RabbitMQMethod | FunctionMethod

export type RexSyncInitArguments = {
  redisUrl: string
